...
validator.addSchema(
  openapi.schema.components.schemas.Image,
  '#/components/schemas/Image'
)
validator.addSchema(
  openapi.schema.components.schemas.CustomField,
  '#/components/schemas/CustomField'
)
validator.addSchema(
  openapi.schema.components.schemas.Link,
  '#/components/schemas/Link'
)
validator.addSchema(
  openapi.schema.components.schemas.Location,
  '#/components/schemas/Location'
)
validator.addSchema(
  openapi.schema.components.schemas.Tag,
  '#/components/schemas/Tag'
)
validator.addSchema(
  openapi.schema.components.schemas.UriImage,
  '#/components/schemas/UriImage'
)
validator.addSchema(
  openapi.schema.components.schemas.ResizinImage,
  '#/components/schemas/ResizinImage'
)
validator.addSchema(
  openapi.schema.components.schemas.VenueCategory,
  '#/components/schemas/VenueCategory'
)
validator.addSchema(
  openapi.schema.components.schemas.VenueVenueCategory,
  '#/components/schemas/VenueVenueCategory'
)
validator.addSchema(
  openapi.schema.components.schemas.VenueCategoryLayout,
  '#/components/schemas/VenueCategoryLayout'
)
validator.addSchema(
  openapi.schema.components.schemas.CustomIcon,
  '#/components/schemas/CustomIcon'
)

const createCompiledSchemaForType = util.memoize(
  (type: eventImport.Item['type']) => {
    if (type === 'performer') {
...
export const validate = async <TItem extends eventImport.Item>(
  ...
  throw errors.createImportError(importer, errors.INVALID_ITEM_DATA, {
    item,
